  ...
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto', padding: '16px', minHeight: '100vh', display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
      <header style={{ textAlign: 'center', margin: '16px 0' }}>
        <h1 style={{ fontSize: '2.2rem', color: 'var(--color-pink)', margin: '0', fontWeight: 'bold' }}>吃点好的 ✨</h1>
        <p style={{ margin: '6px 0 0', fontSize: '0.85rem', color: 'var(--color-text)', opacity: 0.8 }}>把每一顿饭，都变成值得收藏的生活回忆</p>
      </header>
